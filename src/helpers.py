...
def load_filepaths(picklefile="/Users/stefanwijtsma/code/mt/extra_features/filenames.pickle"):
    filepaths = pickle.load(open(picklefile, 'rb'))
    return filepaths

def load_danceability(picklefile="/Users/stefanwijtsma/code/mt/extra_features/danceability.pickle"):
